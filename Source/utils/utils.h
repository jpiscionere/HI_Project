...
extern void copy_from_file_to_file(FILE *dest, FILE *source, size_t size);
...
extern void move_existing_file(const char *fname);
...
extern void* my_align_realloc(void *x,size_t size,int64_t N,size_t alignment,const char *varname);
...
extern void setup_float_bins(const char *fname,float *rmin,float *rmax,int *nbin,float **rupp);
